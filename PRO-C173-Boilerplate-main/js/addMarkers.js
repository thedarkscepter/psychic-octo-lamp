  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        ratingPlane.setAttribute("material", {color: 'olive'});
        ...
        reviewPlane.setAttribute("geometry", {primitive: 'plane', width: 1.5, height: 0.3});
        reviewPlane.setAttribute("material", {color: 'olive'});
